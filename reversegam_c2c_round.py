    ...
    while True:
        ...
        if player_candidates == [] and computer_candidates == []:
            ...
            if player_candidates:
                ...
                p_move = computer_move(board, player_flag)
                # if p_move == 'quit':
...
def main():
    ...
    for i in range(game_num):
        ...
        print('#%d: X scored %d points, O scored %d points.' % (i + 1, score['X'], score['O']))
    ...
    print('X wins: %s  (%s%%)' % (x_wins, round(x_wins / game_num * 100, 2)))
    print('O wins: %s  (%s%%)' % (o_wins, round(o_wins / game_num * 100, 2)))
    print('Ties: %s  (%s%%)' % (ties, round(ties / game_num * 100, 2)))
